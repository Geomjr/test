    ...
    <Screen title="Analytics" back={{ href: "/more", label: "More" }}>
      <div className="grid grid-cols-2 gap-2.5">
        <div className="rounded-[14px] bg-card px-4 py-4">
          <p className="tnum text-[30px] font-bold leading-none">{data.totalContacts}</p>
          <p className="pt-1 text-[13px] text-label-2">people in your orbit</p>
        </div>
        <div className="rounded-[14px] bg-card px-4 py-4">
          <p className="tnum text-[30px] font-bold leading-none">{data.totalInteractions}</p>
          <p className="pt-1 text-[13px] text-label-2">interactions logged</p>
        </div>
      </div>
