# Columbia Business School — Full MBA Class List

A consolidated list of Columbia Business School (CBS) courses, compiled 2026-08-22 from search-engine indexes of the official catalog (`courses.business.columbia.edu`), Columbia's Directory of Classes (`doc.sis.columbia.edu`), Coursicle, Peqod, and CBS curriculum-pathway documents. Direct access to Columbia's sites was blocked by this environment's network policy, so every entry below was cross-checked against indexed copies instead; entries marked ⚠ have weaker evidence (search-summary text only) or unresolved details.

**How CBS numbers its courses**
...
## 1. MBA Core Curriculum (B6xxx) — 12 courses

Two full-term courses plus half-term (A/B term) courses; ~18 core credits. Exemption exams available per course.

- [ ] **B6001** — Financial Accounting *(full-term, 3.0 cr)*
- [ ] **B6100** — Managerial Statistics *(1.5 cr)*
- [ ] **B6101** — Business Analytics *(1.5 cr)*
- [ ] **B6102** — Operations Management *(1.5 cr)*
- [ ] **B6200** — Managerial Economics *(1.5 cr)*
- [ ] **B6201** — Global Economic Environment *(1.5 cr)*
- [ ] **B6300** — Corporate Finance *(full-term, 3.0 cr)*
- [ ] **B6301** — Foundations of Valuation *(1.5 cr)*
- [ ] **B6302** — Corporate Finance (Half-Term) *(1.5 cr)*
- [ ] **B6500** — Lead: People, Teams, Organizations *(1.5 cr)*
- [ ] **B6502** — Strategy Formulation *(1.5 cr)*
- [ ] **B6601** — Marketing *(1.5 cr)*
...
## 3. Decision, Risk & Operations (B81xx)

- [ ] **B8100** — Consulting Practicum: Healthcare Management, Design, and Strategy
- [ ] **B8101** — Business Analytics II
- [ ] **B8105** — Healthcare Analytics
...
- [ ] **B8816** — Quantitative Pricing & Revenue

---

## 4. Business Economics (B82xx)
...
- [ ] **B8322** — Private Equity Field Study
- [ ] **B8329** — Private Equity: Value Creation
- [ ] **B8335** — Private Equity Allocation
- [ ] **B8345** — Entrepreneurial Finance
- [ ] **B8385** — VC Seminar
- [ ] **B8414** — Private Equity
- [ ] **B8419** — Private Equity Capstone
- [ ] **B8439** — Foundations of VC (Half-Term)
- [ ] **B8449** — Foundations of VC (Full-Term)
- [ ] **B8465** — Building a VC Investment Thesis

### Real estate (Paul Milstein Center)
- [ ] **B8331** — Real Estate Finance
- [ ] **B8332** — Real Estate Transactions
- [ ] **B8334** — Capstone: Real Estate Investment
- [ ] **B8336** — Real Estate Portfolio Management
- [ ] **B8337** — Global Real Estate Investment
...
### Deals, corporate finance & governance
- [ ] **B8325** — Mergers & Acquisitions
- [ ] **B8353** — Beyond the Boardroom: The Power of Smart Governance

### Sustainability, impact & specialty finance
- [ ] **B8320** — Climate Tech
- [ ] **B8352** — Financing Energy Infrastructure
- [ ] **B8354** — Personal Finance
- [ ] **B8355** — Impact Investing
- [ ] **B8356** — Financing Innovation in Healthcare
- [ ] **B8363** — Climate Finance
- [ ] **B8365** — Navigating China
...
- [ ] **B8577** — Think Bigger *(Sheena Iyengar)*
...
### Family enterprise (Global Family Enterprise Program)
...
- [ ] **B8623** — Intro to Product Management
- [ ] **B8632** — Digital Product Management Lab
- [ ] **B8633** — Data Science for Marketing Managers
- [ ] **B8636** — Product Management (Full-Term)
- [ ] **B8606** — Product Management Waiver *(placement marker)*
...
- [ ] **B8615** — Media Marketing and Entrepreneurship
- [ ] **B8629** — Entertainment Marketing & the Crafting of Celebrity Businesses
- [ ] **B8637** — The Business of Television and Streaming
- [ ] **B8644** — Sports Economics and Policy
- [ ] **B8666** — Media Platforms and Content: A Foundations Course
- [ ] **B8687** — The Business of Sports

---

## 8. Cross-divisional: climate & society, healthcare, immersions (B87xx–B88xx)

### Climate & social enterprise (Tamer Center)
...
- [ ] **B8718** — Global Immersion: Navigating Argentina's Business Environment
...
- [ ] **B8727** — Global Immersion: The Business Environment in Vietnam
- [ ] **B8729** — Global Immersion: The Innovation and Entrepreneurship Ecosystem in Israel
